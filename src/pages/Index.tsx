            ...
            <div className="container-custom">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                <div className="glass-card p-6 flex flex-col items-center text-center transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Smart Home Security</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Security cameras, video doorbells, smart alarms, and motion sensors.
                  </p>
                ...
                <div className="glass-card p-6 flex flex-col items-center text-center transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Smart Lighting & Switches</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Smart bulbs, light strips, switches, plugs, and dimmer systems.
                  </p>
                  <Link to="/recommendations" className="text-primary hover:underline text-sm mt-auto">
                ...
                <div className="glass-card p-6 flex flex-col items-center text-center transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Smart Climate Control</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Smart thermostats, HVAC controllers, air quality monitors, and fans.
                  </p>
                  <Link to="/recommendations" className="text-primary hover:underline text-sm mt-auto">
                    Browse Climate Products
                  </Link>
                </div>
                ...
                <div className="glass-card p-6 flex flex-col items-center text-center transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Smart Entertainment</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Smart speakers, displays, TVs, streaming devices, and audio systems.
                  </p>
                  <Link to="/recommendations" className="text-primary hover:underline text-sm mt-auto">
                ...
                <div className="glass-card p-6 flex flex-col items-center text-center transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Smart Locks & Access</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Smart door locks, garage door openers, and keyless entry systems.
                  </p>
                  <Link to="/recommendations" className="text-primary hover:underline text-sm mt-auto">
                    Browse Access Products
                  </Link>
                </div>
                
                <div className="glass-card p-6 flex flex-col items-center text-center transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
                  <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center mb-4">
                    <BatteryCharging size={24} className="text-primary" />
                  </div>
                  <h3 className="text-lg font-semibold mb-2">Smart Appliances</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Robot vacuums, washing machines, refrigerators, and other smart appliances.
                  </p>
                  <Link to="/recommendations" className="text-primary hover:underline text-sm mt-auto">
                    Browse Appliance Products
                  </Link>
                </div>
                ...
                <div className="glass-card p-6 flex flex-col items-center text-center transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Smart Hubs & Controllers</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Smart home hubs, voice assistants, and universal remote controls.
                  </p>
                  <Link to="/recommendations" className="text-primary hover:underline text-sm mt-auto">
                    Browse Control Products
                  </Link>
                </div>
                ...
                <div className="glass-card p-6 flex flex-col items-center text-center transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Outdoor Smart Devices</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Outdoor cameras, lighting, smart lawn mowers, and sprinkler systems.
                  </p>
                  <Link to="/recommendations" className="text-primary hover:underline text-sm mt-auto">
